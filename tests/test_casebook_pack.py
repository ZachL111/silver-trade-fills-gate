"""Regression checks for the silver-trade-fills-gate casebook."""
...
from casebook.harness import assert_expected, silver_trade_fills_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_trade_fills_gate_summary(), assert_expected())
