...
`silver-trade-fills-gate` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for fills systems, covering resource planning, capacity fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 160. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 2.
